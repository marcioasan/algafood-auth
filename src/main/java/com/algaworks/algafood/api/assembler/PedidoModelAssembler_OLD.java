...
//19.20. Refatorando construção e inclusão de links em representation model - Classe refatorada nessa aula,deixei essa como old e criei outra com a refatoração da aula

@Component
public class PedidoModelAssembler_OLD extends RepresentationModelAssemblerSupport<Pedido, PedidoModel> {

    @Autowired
    private ModelMapper modelMapper;
    
    public PedidoModelAssembler_OLD() {
        super(PedidoController.class, PedidoModel.class);
    }
    
    //19.18. Adicionando links com template variables - 2'20", 4'
	@Override
