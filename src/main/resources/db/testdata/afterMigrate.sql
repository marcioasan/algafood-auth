...
delete from restaurante_usuario_responsavel; #12.17. Desafio: implementando endpoints de associação de usuários responsáveis com restaurantes
delete from usuario;
...
#12.4. Implementando os endpoints de ativacao e inativacao de restaurantes - 3'30", inclusao da coluna 'ativo'
#12.14. Desafio: Implementando os endpoints de abertura e fechamento de restaurantes, inclusao da coluna 'aberto'
...
insert into usuario (id, nome, email, senha, data_cadastro) values
(6, 'Débora Mendonça', 'marcioasan@gmail.com+debora@gmail.com', '123', utc_timestamp),
(7, 'Carlos Lima', 'marcioasan@gmail.com+carlos@gmail.com', '123', utc_timestamp);
...
values (1, '674a2365-7d46-4de2-b666-adc0f2518e7a', 1, 6, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
        endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
        status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, 'b10a1f53-98b4-11ed-821a-641c67892cca', 4, 6, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
